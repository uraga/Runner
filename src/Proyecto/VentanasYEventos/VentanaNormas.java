...
public class VentanaNormas extends JFrame {
	...
	public VentanaNormas() {
		...
		txtpnNormasDeLa.setText("Hola bienvenido, estas apunto de jugar a este runner por favor lee antentamente las normas basicas del juego.\n\nEste juego esta basado en el dinosaurio de Google Chrome el cual consiste en ir avanzando e ir saltando los obstaculos que van apareciendo.En el caso de choque nuestro personaje Dino muere y se acaba la partida.Cada obsstaculo superado supondra un incremento de 20 puntos en la puntuacion.En este enlace se explica mas detalladamente ____ (enlace)");
